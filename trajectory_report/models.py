...
class Serves(Base):
    ...
    object_id: Mapped[int] = mapped_column(ForeignKey('objects_site.object_id'))
    date: Mapped[dt.date]
    ...
    def __repr__(self):
        return (f"Name: {self.name_id} Object: {self.object_id} "
...
class Statements(Base):
    ...
    def __repr__(self):
        return (f"Statements({self.id}, {self.division}, {self.name_id}, "
...
class Coordinates(Base):
    ...
    __table_args__ = (
        Index('subsIdRequestDate', 'subscriberID',
              'requestDate', 'locationDate'),
...
class Clusters(Base):
    ...
    __table_args__ = (
            Index('subsIdDate', 'subscriberID', 'date'),
    )
...
class Journal(Base):
    ...
    def __repr__(self):
        return (f"SubsID: {self.subscriberID} Name_id: {self.name_id} "
